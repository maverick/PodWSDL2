...
BEGIN {use_ok('Pod::WSDL2::Attr')}
use strict;
use warnings;

eval {
	my $a1 = new Pod::WSDL2::Attr();
};

ok(defined $@, 'new dies, if it does not get a string');

eval {
	my $a1 = new Pod::WSDL2::Attr('myAttr $string _NEEDED blah blah ...');
};

ok(defined $@, 'new dies, if it does not get a string beginning with _ATTR');

eval {
	my $a1 = new Pod::WSDL2::Attr('_ATTR myAttr string _NEEDED blah blah ...');
};
...
$a1 = new Pod::WSDL2::Attr('   _ATTR myAttr $string _NEEDED blah blah ...');
