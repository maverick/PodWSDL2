...
BEGIN {use_ok('Pod::WSDL2::Fault')}
use strict;
use warnings;

eval {
	my $a1 = new Pod::WSDL2::Fault();
};

ok(defined $@, 'new dies, if it does not get a string');

eval {
	my $a1 = new Pod::WSDL2::Fault('blah blah ...');
};

ok(defined $@, 'new dies, if it does not get a string beginning with _FAULT');

eval {
	my $a1 = new Pod::WSDL2::Fault('_FAULT My::Fault blah blah ...');
};
...
$a1 = new Pod::WSDL2::Fault('   _FAULT My::Fault blah blah ...');
ok($a1->wsdlName eq 'MyFault', 'Handles whitespace before _FAULT correctly.');

$a1 = new Pod::WSDL2::Fault('_FAULT My::Fault');
